...
- sc.rest.jsonPost("urlString", {json document}) - return json document
- sc.rest.jsonPost("urlString", neo4jNode) - return json document
- sc.rest.jsonPost("urlString", neo4jRelationship) - return json document
