...
public class UrlEncodeNode {
    ...
    @UserFunction
    @Description("MATCH (n) WHERE ID(n)= 123 RETURN example.urlEncodeNode(n) - return  url encoded node properties")
    public String urlEncodeNode(
