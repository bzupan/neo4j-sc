...
/*
    ...
    // ----------------------------------------------------------------------------------
    @UserFunction
    @Description("RETURN sc.cypher.runFunctionVm(\"stringFunctionName\", {object:\"params\"} - run CYPHER from Java VM)")
    ...
    // ----------------------------------------------------------------------------------
    @UserFunction
    @Description("RETURN sc.cypher.runCypherNode(\"stringFunctionName\", {object:\"params\"} - run CYPHER from Neo4j DB)")
